<nav class="site-navbar navbar navbar-default navbar-fixed-top navbar-mega" role="navigation">
    ...
    <div class="navbar-header">
        ...
        <div class="navbar-brand navbar-brand-center site-gridmenu-toggle" data-toggle="gridmenu" style="padding:0.5715rem 1.429rem">
            <img class="navbar-brand-logo" src="{{asset('images/logo_home.png')}}" title="Remark" style="height:100%;margin-top:0">
            <span class="navbar-brand-text hidden-xs-down">Remitty Delivery</span>
        </div>
        ...
        <div>
            <div>
                <ul class="site-menu" data-plugin="menu">
                    ...
                    <li class="site-menu-item {{isset($menu_level1) && $menu_level1=='setting' ? ' active' : '' }}">
                        <a href="{{url('setting')}}">
                            <i class="site-menu-icon wb-dashboard" aria-hidden="true"></i>
                            <span class="site-menu-title">Global Setting</span>
                        </a>
                    </li>
