                ...
                <nav>
                    <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                        @for($i=0;$i<count($result['job']);$i++)
                            <a class="nav-item nav-link {{$result['event']['job_id']!=$result['job'][$i]['id']?'disabled':'active'}}" id="nav-job-{{$i}}" data-toggle="tab" href="#nav-job-panel-{{$i}}" role="tab" aria-selected="true">{{$result['job'][$i]['type']}} {{!is_null($result['job'][$i]['variation'])?'-':''}} {{$result['job'][$i]['variation']}}</a>
                        @endfor
                    </div>
                </nav>
                        ...
                        <div class="tab-pane fade {{$i==0 ? 'show active' : ''}}" id="nav-job-panel-{{$i}}" role="tabpanel" aria-labelledby="nav-home-tab">
                            <div class="section">
                                ...
                                <form autocomplete="off" method="post" id="event_form-{{$i}}" class="event_form" action="{{url('employee/save')}}" enctype="multipart/form-data">
                                        ...
                                        <div class="col-lg-6 col-12">
                                            <div class="form-group" style="">
                                                ...
                                                <div class="label-input">
                                                    ...
                                                    <div>
                                                        <input type="text" class="form-control" id="pick_address-tab-{{$i}}" name="pick_address" placeholder="Pick Up Address" value="{{$result['event']['pick_address']}}" autocomplete="off"/>
                                                    </div>
                                                </div>
                                                <div class="label-input">
                                                    <div><label class="form-control-label">Drop Off Address<span class="mandatory">(Mandatory)</span>: </label></div>
                                                    <div>
                                                        <input type="text" class="form-control" id="drop_address-tab-{{$i}}" name="drop_address" autocomplete="off" value="{{$result['event']['drop_address']}}" placeholder="Drop Off Address"/>
                                                    </div>
                                                </div>
                                                <div class="label-input">
                                                    ...
                                                    <div id="stop-holder-tab-{{$i}}">
                                                        ...
                                                        @for($j=0;$j<count($result['event']['stop_address']);$j++)
                                                            <div class="row" style="margin-left:0 !important;margin-right:0 !important;">
                                                                <input type="text" class="form-control"  name="stop_address-{{$j+1}}" id="stop_address-tab-{{$i}}-{{$j+1}}" style="margin-bottom:5px;width:200px !important;" value="{{$result['event']['stop_address'][$j]}}" autocomplete="off"/>
                                                                <span class="remove-stop">
                                                ...
                                                <div class="label-input">
                                                    ...
                                                    <div>
                                                        <input type="number" class="form-control" id="non_profit-tab-{{$i}}" name="non_profit" value="{{$result['event']['non_profit']}}"
                                                               autocomplete="off"/>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="label-input">
                                                    ...
                                                    <div>
                                                        <input type="number" class="form-control" id="flat-tab-{{$i}}" name="flat"
                                                               value="{{$result['event']['flat']}}" autocomplete="off"/>
                                                    </div>
                                                </div>
                                                @else
                                                    <div class="label-input">
                                                        ...
                                                        <div>
                                                            <input type="number" class="form-control" id="hourly_rate-tab-{{$i}}" name="hourly_rate"
                                                                   value="{{$result['event']['hourly_rate']}}" autocomplete="off"/>
                                                        </div>
                                                    </div>
                                                @endif
                                                ...
                                                <div class="label-input">
                                                    ...
                                                    <div>
                                                        <input type="number" class="form-control" id="packing-tab-{{$i}}" name="packing"
                                                               value="{{$result['event']['packing']}}" autocomplete="off"/>
                                                    </div>
                                                </div>
                                                <div class="label-input">
                                                    ...
                                                    <div>
                                                        <input type="number" class="form-control" id="service-tab-{{$i}}" name="service"
                                                               value="{{$result['event']['service']}}" autocomplete="off"/>
                                                    </div>
                                                </div>
                                                <div class="label-input">
                                                    ...
                                                    <div>
                                                        <input type="number" class="form-control" id="extra-tab-{{$i}}" name="extra"
                                                               value="{{$result['event']['extra']}}" autocomplete="off"/>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="label-input">
                                                    ...
                                                    <div>
                                                        <input type="number" class="form-control" id="job_total-tab-{{$i}}" name="job_total"
                                                               value="{{$result['event']['job_total']}}" autocomplete="off" readonly/>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="label-input" style="margin-top:50px">
                                                    ...
                                                    <div>
                                                        <input type="number" class="form-control" id="discount_tab-{{$i}}" name="discount"
                                                               value="{{$result['event']['discount']}}" autocomplete="off"/>
                                                    </div>
                                                </div>
                                                <div class="label-input">
                                                    ...
                                                    <div>
                                                        <input type="number" class="form-control" id="tips-tab-{{$i}}" name="tips"
                                                               value="{{$result['event']['tips']}}" autocomplete="off"/>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-12 col-lg-6">
                                            <div class="form-group"  style="">
                                                ...
                                                <div class="label-input">
                                                    ...
                                                    <div>
                                                        <textarea class="form-control" id="event_comment-tab-{{$i}}" name="event_comment" rows="5">{{$result['event']['comment']}}</textarea>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="label-input">
                                                    ...
                                                    <div>
                                                        <input type="text" class="form-control date_time" id="finish_time-tab-{{$i}}" name="finish_time" autocomplete="off" value="{{$result['event']['finish_time']}}" placeholder="Finish Time"/>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="label-input">
                                                    ...
                                                    <div>
                                                        <input type="number" class="form-control" id="travel_time-tab-{{$i}}" value="{{$result['event']['travel_time']}}" name="travel_time"
                                                               autocomplete="off"/>
                                                    </div>
                                                </div>
                                                <div class="label-input">
                                                    ...
                                                    <div>
                                                        <input type="text" class="form-control" id="total_hours-tab-{{$i}}" name="total_hours"
                                                               value="{{$result['event']['total_hours']}}" autocomplete="off" readonly/>
                                                    </div>
                                                </div>
                                    ...
                                    <input style="display:none" id="event_id-tab-{{$i}}" name="event_id" value="{{$result['event']['id']}}"/>
                                </form>
                            </div>
                            ...
                            <div class="section">
                                ...
                                <div class="table-responsive table">
                                    <table id="selected-employees-tab-{{$i}}" style="width:100%">
                                        ...
                                        <tbody>
                                            @for($j=0;$j<count($result['event_employees']);$j++)
                                                <tr>
                                                    <td>{{$result['event_employees'][$j]['name']}}</td>
                                                    <td>{{$result['event_employees'][$j]['position']}}</td>
                                                    <td>{{$result['event_employees'][$j]['total_hours']}}</td>
                                                    <td>{{$result['event_employees'][$j]['bonus']}}</td>
                                                    <td>{{$result['event_employees'][$j]['hourly_pay']}}</td>
                                                    @if($result['job'][$i]['type']=='Hourly')
                                                        <td>{{$result['event_employees'][$j]['hourly_percent']}}</td>
                                                    @else
                                                        <td>{{$result['event_employees'][$j]['flat_percent']}}</td>
                                                    @endif


                                                    <td>{{$result['event_employees'][$j]['extra_percent']}}</td>
                                                    <td>{{$result['event_employees'][$j]['packing_percent']}}</td>
                                                    <td>{{$result['event_employees'][$j]['service_percent']}}</td>

                                                    <td>
                                                        <button type="button" class="btn btn-floating btn-success btn-sm edit" style="width:30px;height:30px" onclick="editEmployee('{{$i}}',this)"><i class="icon wb-pencil" aria-hidden="true"></i></button>
                                                        <button type="button" class="btn btn-floating btn-danger btn-sm remove" style="width:30px;height:30px;margin-left:5px;" onclick="deleteEmployee('{{$i}}',this)"><i class="icon fa-trash" aria-hidden="true"></i></button>
                                                    </td>
                                                    <td>{{$result['event_employees'][$j]['payment_description']}}</td>
                                                </tr>
