                                        ...
                                        <div class="col-lg-6 col-12">
                                            <div class="form-group" style="">
                                                <div class="label-input">
                                                    ...
                                                    <div>
                                                        <input type="text" class="form-control" id="customer-name-tab-{{$i}}" name="customer_name" placeholder="Customer Name" autocomplete="off"/>
                                                    </div>
                                                </div>
                                                <div class="label-input">
                                        ...
                                        <div class="col-12 col-lg-6">
                                            <div class="form-group"  style="">
                                                <div class="label-input">
                                                    ...
                                                    <div>
                                                        <input type="text" class="form-control" name="truck_license" placeholder="Truck License" id="truck-license-tab-{{$i}}" autocomplete="off"/>
                                                    </div>
                                                </div>
                                                <div class="label-input">
