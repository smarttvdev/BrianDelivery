...
{
    use Queueable;
    protected $customer_id, $order_title, $order_content, $start_lat, $start_lng, $end_lat, $end_lng, $min_price, $max_price, $round_trip,
              $stuff_weight, $stuff_width, $stuff_height, $waiting_time;


    public function __construct($customer_id, $order_title, $order_content, $start_lat, $start_lng, $end_lat, $end_lng, $min_price, $max_price, $round_trip,
                                $stuff_weight, $stuff_width, $stuff_height, $waiting_time)
    {
